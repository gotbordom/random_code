...
def sim_dist(prefs,person1,person2):
  ...
  # Sum of squares:
  sum_sqrs = sum([pow(prefs[person1][item]-prefs[person2][item],2) for item in si])
...
#def sim_tanimoto(prefs,p1,p2):
  # This is just the intersection / Union:
  # Though this doesn't seem like a good approach for predicting movies... unless using thresholding..
  # Better examples are for item comparisons. 
    # A user purchased 10/15 items being compared. 
